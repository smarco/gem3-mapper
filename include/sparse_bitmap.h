 ...
 * Check
 */
#define SPARSE_BITMAP_CHECK(sparse_bitmap) \
  GEM_CHECK_NULL(sparse_bitmap)
#define SPARSE_BITMAP_BUILDER_CHECK(sparse_bitmap_builder) \
  GEM_CHECK_NULL(sparse_bitmap_builder)
#define SPARSE_BITMAP_STATS_CHECK(sparse_bitmap_stats) \
  GEM_CHECK_NULL(sparse_bitmap_stats)
