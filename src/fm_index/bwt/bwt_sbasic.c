...
bwt_sbasic_builder_t* bwt_sbasic_builder_new(
   ...
   */
  bwt_sbasic_builder_t* const bwt_builder = mm_alloc(bwt_sbasic_builder_t);
...
bwt_sbasic_t* bwt_sbasic_read_mem(mm_t* const memory_manager) {
  ...
  gem_cond_error(bwt_serial_no!=BWT_SBASIC_MODEL_NO,BWT_WRONG_MODEL_NO,bwt_serial_no,(uint64_t)BWT_SBASIC_MODEL_NO);
