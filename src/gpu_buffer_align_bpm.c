...
void gpu_buffer_align_bpm_compute_dimensions(
  ...
  const uint64_t gpu_pattern_num_entries = bpm_pattern->gpu_num_entries;
  const uint64_t gpu_pattern_num_tiles = bpm_pattern->gpu_num_tiles;
  *total_entries += gpu_pattern_num_entries;
  *total_queries += gpu_pattern_num_tiles;
  *total_candidates += gpu_pattern_num_tiles*num_candidates;
}
...
void gpu_buffer_align_bpm_pattern_decompile(
    gpu_bpm_qry_entry_t* const pattern_entry,const uint32_t pattern_length,
...
void gpu_buffer_align_bpm_add_pattern(
  ...
  const uint64_t gpu_num_entries = bpm_pattern->gpu_num_entries;
  const uint64_t gpu_entries_per_tile = bpm_pattern->gpu_entries_per_tile;
  const uint64_t gpu_num_tiles = bpm_pattern->gpu_num_tiles;
  // Add query (Metadata)
  const uint32_t buffer_pattern_query_offset = gpu_buffer_align_bpm->num_queries;
  (gpu_buffer_align_bpm->num_queries) += gpu_num_tiles;
  ...
  gpu_buffer_align_bpm->num_entries += gpu_num_entries;
 ...
 * Computing Device
 */
void gpu_buffer_align_bpm_set_device_cpu(gpu_buffer_align_bpm_t* const gpu_buffer_align_bpm) { GEM_CUDA_NOT_SUPPORTED(); }
void gpu_buffer_align_bpm_set_device_gpu(gpu_buffer_align_bpm_t* const gpu_buffer_align_bpm) { GEM_CUDA_NOT_SUPPORTED(); }
/*
 * Occupancy & Limits
 */
uint64_t gpu_buffer_align_bpm_get_max_candidates(gpu_buffer_align_bpm_t* const gpu_buffer_align_bpm) { GEM_CUDA_NOT_SUPPORTED(); return 0; }
uint64_t gpu_buffer_align_bpm_get_max_queries(gpu_buffer_align_bpm_t* const gpu_buffer_align_bpm) { GEM_CUDA_NOT_SUPPORTED(); return 0; }
uint64_t gpu_buffer_align_bpm_get_num_candidates(gpu_buffer_align_bpm_t* const gpu_buffer_align_bpm) { GEM_CUDA_NOT_SUPPORTED(); return 0; }
uint64_t gpu_buffer_align_bpm_get_num_queries(gpu_buffer_align_bpm_t* const gpu_buffer_align_bpm) { GEM_CUDA_NOT_SUPPORTED(); return 0; }
void gpu_buffer_align_bpm_compute_dimensions(
    gpu_buffer_align_bpm_t* const gpu_buffer_align_bpm,bpm_pattern_t* const bpm_pattern,
    const uint64_t num_candidates,uint64_t* const total_entries,
    uint64_t* const total_queries,uint64_t* const total_candidates) { GEM_CUDA_NOT_SUPPORTED(); }
bool gpu_buffer_align_bpm_fits_in_buffer(
    gpu_buffer_align_bpm_t* const gpu_buffer_align_bpm,const uint64_t total_entries,
    const uint64_t total_queries,const uint64_t total_candidates) { GEM_CUDA_NOT_SUPPORTED(); return false; }
/*
 * Accessors
 */
void gpu_buffer_align_bpm_add_pattern(
    gpu_buffer_align_bpm_t* const gpu_buffer_align_bpm,bpm_pattern_t* const bpm_pattern) { GEM_CUDA_NOT_SUPPORTED(); }
void gpu_buffer_align_bpm_add_candidate(
    gpu_buffer_align_bpm_t* const gpu_buffer_align_bpm,const uint64_t tile_offset,
...
void gpu_buffer_align_bpm_retrieve_pattern(
    gpu_buffer_align_bpm_t* const gpu_buffer_align_bpm,const uint64_t candidate_offset,
    bpm_pattern_t* const bpm_pattern,mm_stack_t* const mm_stack) { GEM_CUDA_NOT_SUPPORTED(); }
/*
 * Hints
 */
void gpu_buffer_align_bpm_record_query_length(
    gpu_buffer_align_bpm_t* const gpu_buffer_align_bpm,const uint64_t query_length) { GEM_CUDA_NOT_SUPPORTED(); }
void gpu_buffer_align_bpm_record_candidates_per_query(
    gpu_buffer_align_bpm_t* const gpu_buffer_align_bpm,const uint64_t num_candidates) { GEM_CUDA_NOT_SUPPORTED(); }
uint64_t gpu_buffer_align_bpm_get_mean_query_length(
