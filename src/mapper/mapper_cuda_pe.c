 ...
 * Check Occupancy
 */
bool mapper_pe_cuda_stage_read_input_sequences_exhausted(mapper_cuda_search_t* const restrict mapper_search) {
...
bool mapper_pe_cuda_stage_region_profile_output_exhausted(mapper_cuda_search_t* const restrict mapper_search) {
...
bool mapper_pe_cuda_stage_decode_candidates_output_exhausted(mapper_cuda_search_t* const restrict mapper_search) {
 ...
 */
void mapper_pe_cuda_region_profile(mapper_cuda_search_t* const restrict mapper_search) {
 ...
 */
void mapper_pe_cuda_decode_candidates(mapper_cuda_search_t* const restrict mapper_search) {
 ...
 *   Send to CUDA Decode-Candidates
 */
void mapper_pe_cuda_generate_candidates(mapper_cuda_search_t* const restrict mapper_search) {
  PROFILE_START(GP_MAPPER_CUDA_PE_DECODE_CANDIDATES,PROFILE_LEVEL);
  // Parameters
  mapper_parameters_t* const restrict parameters = mapper_search->mapper_parameters;
  search_pipeline_t* const restrict search_pipeline = mapper_search->search_pipeline;
 ...
 */
void mapper_pe_cuda_verify_candidates(mapper_cuda_search_t* const restrict mapper_search) {
 ...
 *   Output Matches
 */
void mapper_pe_cuda_finish_search(mapper_cuda_search_t* const restrict mapper_search) {
 ...
 * Mapper PE-CUDA
 */
void* mapper_cuda_pe_thread(mapper_cuda_search_t* const restrict mapper_search) {
