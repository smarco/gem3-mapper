...
paired_matches_class_t paired_matches_classify(paired_matches_t* const restrict paired_matches) {
  // Parameters
  matches_metrics_t* const restrict metrics = &paired_matches->metrics;
  // Unmapped
  ...
  match_trace_t* const restrict primary_end1 = paired_map_get_match_end1(paired_matches,paired_map);
  match_trace_t* const restrict primary_end2 = paired_map_get_match_end2(paired_matches,paired_map);
  //  // High quality ends
  ...
  match_trace_t* const restrict subdominant_end1 = paired_map_get_match_end1(paired_matches,paired_map+1);
  match_trace_t* const restrict subdominant_end2 = paired_map_get_match_end2(paired_matches,paired_map+1);
