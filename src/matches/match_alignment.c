...
void match_alignment_print_pretty(
  ...
  char* const restrict key_alg = mm_stack_calloc(mm_stack,max_buffer_length,char,true);
  char* const restrict ops_alg = mm_stack_calloc(mm_stack,max_buffer_length,char,true);
  char* const restrict text_alg = mm_stack_calloc(mm_stack,max_buffer_length,char,true);
