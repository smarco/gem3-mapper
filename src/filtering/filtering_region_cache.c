...
bool filtering_region_cache_cmp_regions(
    filtering_region_t* const restrict filtering_region_a,
    filtering_region_t* const restrict filtering_region_b,
    text_collection_t* const restrict text_collection) {
  // Cmp read
  const text_trace_t* const restrict text_trace_a = text_collection_get_trace(text_collection,filtering_region_a->text_trace_offset);
  const text_trace_t* const restrict text_trace_b = text_collection_get_trace(text_collection,filtering_region_b->text_trace_offset);
...
match_trace_t* filtering_region_transient_cache_search(
  ...
  filtering_region_cache_element_t* const restrict last_aligned = &filtering_region_cache->last_aligned;
...
//  filtering_region_cache_element_t* const restrict cache_element =
