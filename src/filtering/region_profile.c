...
void region_profile_query_character(
  ...
  if (!rank_mquery_is_exhausted(rank_mquery)) {
    rank_mtable_t* const restrict rank_mtable = fm_index->rank_table;
...
int region_profile_locator_cmp(
    const region_locator_t* const restrict a,
    const region_locator_t* const restrict b) {
  return (int)a->value - (int)b->value;
}
void region_profile_locator_sort(
    region_locator_t* const restrict loc,
