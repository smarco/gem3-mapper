...
sampled_rl_t* sampled_rl_new(
  ...
  // Allocate handler
  sampled_rl_t* const restrict sampled_rl = mm_alloc(sampled_rl_t);
...
uint64_t sampled_rl_get_sample(sampled_rl_t* const restrict sampled_rl,const uint64_t array_position) {
  // Store SA position
