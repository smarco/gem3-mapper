...
void archive_search_prepare_sequence(archive_search_t* const restrict archive_search) {
  ...
  approximate_search_t* const restrict forward_search_state = &archive_search->forward_search_state;
  ...
  if (archive_search->emulate_rc_search) {
    approximate_search_t* const restrict reverse_search_state = &archive_search->reverse_search_state;
