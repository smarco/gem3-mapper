...
void matches_predictors_compute_mapped(
    matches_predictors_t* const predictors,matches_metrics_t* const matches_metrics,
    const uint64_t primary_map_distance,const uint64_t primary_map_edit_distance,
    const int32_t primary_map_swg_score,const uint64_t read_length,
...
void matches_predictors_compute(
    ...
    approximate_search_metrics_t* const search_metrics,const uint64_t mcs) {
  // Parameters
...
void paired_matches_predictors_compute(
    ...
    const uint64_t mcs_end1,const uint64_t mcs_end2) {
  // Parameters
...
void matches_predictors_print(
    FILE* const stream,const char* const sequence_tag,
    const char* const match_class,matches_predictors_t* const predictors) {
  // Tag
...
void matches_predictors_se_print(
    FILE* const stream,const char* const sequence_tag,
    const matches_class_t matches_class,matches_predictors_t* const predictors) {
  // Class
