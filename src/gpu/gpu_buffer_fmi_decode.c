...
gpu_buffer_fmi_decode_t* gpu_buffer_fmi_decode_new(
  ...
  gpu_buffer_fmi_decode_t* const restrict gpu_buffer_fmi_decode = mm_alloc(gpu_buffer_fmi_decode_t);
...
void gpu_buffer_fmi_decode_add_query(
  ...
  gpu_fmi_decode_init_pos_t* const restrict gpu_fmi_decode_init_pos =
...
void gpu_buffer_fmi_decode_get_position_sa(
  ...
  // Get query
  const gpu_fmi_decode_end_pos_t* const restrict gpu_fmi_decode_end_pos =
...
void gpu_buffer_fmi_decode_get_position_text(
  ...
  // Get query
  const gpu_sa_decode_text_pos_t* const restrict gpu_fmi_decode_end_pos =
 ...
 * CPU emulated
 */
void gpu_buffer_fmi_decode_compute_cpu(gpu_buffer_fmi_decode_t* const restrict gpu_buffer_fmi_decode) {
  // Parameters
  gpu_fmi_decode_init_pos_t* const restrict gpu_fmi_decode_bwt_positions =
      gpu_fmi_decode_buffer_get_init_pos_(gpu_buffer_fmi_decode->buffer);
  gpu_fmi_decode_end_pos_t* const restrict gpu_fmi_decode_sampled_bwt_positions =
  ...
  for (buffer_pos=0;buffer_pos<num_queries;++buffer_pos) {
    // Get Query/Result
    gpu_fmi_decode_init_pos_t* const restrict gpu_fmi_decode_bwt_position = gpu_fmi_decode_bwt_positions + buffer_pos;
    gpu_fmi_decode_end_pos_t* const restrict gpu_fmi_decode_sampled_bwt_position = gpu_fmi_decode_sampled_bwt_positions + buffer_pos;
...
void gpu_buffer_fmi_decode_send(gpu_buffer_fmi_decode_t* const restrict gpu_buffer_fmi_decode) {
  ...
  if (gpu_buffer_fmi_decode->gpu_decode_sa) {
    if (gpu_buffer_fmi_decode->num_queries > 0) {
      sampled_sa_t* const restrict sampled_sa = gpu_buffer_fmi_decode->fm_index->sampled_sa;
...
void gpu_buffer_fmi_decode_clear(
    gpu_buffer_fmi_decode_t* const restrict gpu_buffer_fmi_decode) { GEM_CUDA_NOT_SUPPORTED(); }
...
uint64_t gpu_buffer_fmi_decode_get_max_queries(
    gpu_buffer_fmi_decode_t* const restrict gpu_buffer_fmi_decode) { GEM_CUDA_NOT_SUPPORTED(); return 0; }
...
void gpu_buffer_fmi_decode_get_position_sa(
    ...
    const uint64_t buffer_pos,
    uint64_t* const restrict bwt_sampled_position,
    uint64_t* const restrict lf_steps) { GEM_CUDA_NOT_SUPPORTED(); }
void gpu_buffer_fmi_decode_get_position_text(
    gpu_buffer_fmi_decode_t* const restrict gpu_buffer_fmi_decode,
    const uint64_t buffer_pos,
    uint64_t* const restrict text_position) { GEM_CUDA_NOT_SUPPORTED(); }
/*
 * Send/Receive
 */
