...
void match_scaffold_levenshtein_compose_alignment(
    match_scaffold_t* const match_scaffold,matches_t* const matches,
    const match_alignment_t* const match_alignment,uint8_t* const text,
    uint64_t key_offset,const uint64_t matching_min_length,
...
void match_scaffold_levenshtein_tiled(
    match_scaffold_t* const match_scaffold,match_align_input_t* const align_input,
    const uint64_t matching_min_length,const bool left_gap_alignment,
    bpm_pattern_t* const bpm_pattern_tile,const uint64_t key_offset,
