...
GEM_INLINE void region_profile_print_fixed_regions(FILE* const stream,const region_profile_t* const region_profile,const uint8_t* key) {
  REGION_PROFILE_ITERATE(region_profile,region,position) {
