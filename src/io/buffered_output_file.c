 ...
 * Setup
 */
buffered_output_file_t* buffered_output_file_new(output_file_t* const restrict output_file) {
...
void buffered_output_file_close(buffered_output_file_t* const restrict buffered_output) {
...
void buffered_output_file_request_buffer(
    buffered_output_file_t* const restrict buffered_output,
    const uint32_t block_id) {
  buffered_output->buffer = output_file_request_buffer(buffered_output->output_file,block_id);
}
void buffered_output_file_dump_buffer(buffered_output_file_t* const restrict buffered_output) {
...
void buffered_output_file_safety_dump_buffer(buffered_output_file_t* const restrict buffered_output) {
 ...
 */
//int vbofprintf(buffered_output_file_t* const restrict buffered_output,const char *template,va_list v_args) {
...
//}
//int bofprintf(buffered_output_file_t* const restrict buffered_output,const char *template,...) {
//  GEM_CHECK_NULL(template);
//  va_list v_args;
 ...
 * Fast-printer
 */
void bofprintf_uint64(buffered_output_file_t* const restrict buffered_output,const uint64_t number) {
  bprintf_uint64(buffered_output->buffer,number);
}
void bofprintf_int64(buffered_output_file_t* const restrict buffered_output,const int64_t number) {
  bprintf_int64(buffered_output->buffer,number);
}
void bofprintf_char(buffered_output_file_t* const restrict buffered_output,const char character) {
