 ...
 * Accessors
 */
void output_buffer_set_state(output_buffer_t* const restrict out_buffer,const output_buffer_state_t buffer_state) {
  out_buffer->buffer_state=buffer_state;
}
output_buffer_state_t output_buffer_get_state(output_buffer_t* const restrict out_buffer) {
  return out_buffer->buffer_state;
}
void output_buffer_set_incomplete(output_buffer_t* const restrict out_buffer) {
  out_buffer->is_final_block=false;
}
uint64_t output_buffer_get_used(output_buffer_t* const restrict out_buffer) {
...
void bprintf_buffer(
    output_buffer_t* const restrict out_buffer,const int string_length,const char* const restrict string) {
