...
//
//
//  if (align_parameters->scaffolding) { // FIXME
//    PROFILE_PAUSE(GP_MATCHES_ALIGN_SWG,PROFILE_LEVEL); // FIXME
//    match_scaffold_adaptive(matches,align_input,align_parameters,match_scaffold,mm_stack); // FIXME
//    PROFILE_CONTINUE(GP_MATCHES_ALIGN_SWG,PROFILE_LEVEL); // FIXME
//  } // FIXME
//
...
//  // Adjust text
//  match_alignment->match_text_offset = match_alignment->match_position - base_match_position;
