...
void approximate_search_metrics_init(
    approximate_search_metrics_t* const search_metrics,const double proper_length,
    const uint64_t read_length,const int32_t swg_match_score) {
  // Search Magnitudes
...
void approximate_search_metrics_set_max_region_length(
    approximate_search_metrics_t* const search_metrics,const uint64_t max_region_length) {
  search_metrics->max_region_length = max_region_length;
}
void approximate_search_metrics_set_num_zero_regions(
    approximate_search_metrics_t* const search_metrics,const uint64_t num_zero_regions) {
...
void approximate_search_metrics_set_mappability(
    ...
    const double mappability_p,const double mappability_2p) {
...
void approximate_search_metrics_print(
    FILE* const stream,approximate_search_metrics_t* const search_metrics) {
