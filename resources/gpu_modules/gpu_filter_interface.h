...
void gpu_bpm_send_buffer_(void* const __restrict__ bpmBuffer, const uint32_t numPEQEntries, const uint32_t numQueries, const uint32_t numCandidates, const uint32_t sizeCandidates);
